Feature: Edit Activity
    ...
    Scenario: edit the date of an activity to the start date
    ...
    Scenario: I am changing the compliance date I should put the end date of the activity
        Given entered with a director account
        When I click on button  "Cargar PDF" at the top
        And click on button  "cargar nuevo PDF"
        And click on button "seleccionar Archivo"
        ...
        And click on  "1. PORCENTAJE DE PROGRAMAS ACREDITADOS. PORCENTAJE DE CUMPLIMIENTO EN LOS PLANES DE MEJORAMIENTO SEGÚN RECOMENDACIONES DE EVALUACIÓN EXTERNA"
        And click on  "editar" in the first activity
        And add date  "24-02-2020"
        And click on  "Cuardar cambios"
        
        Then should show the date "24-02-2020" in the first activity

    Scenario: I am changing the compliance date I should put the activity start date
        Given entered with a director account
        When I click on button  "Cargar PDF" at the top
        And click on button  "cargar nuevo PDF"
        And click on button "seleccionar Archivo"
        ...
        And click on  "1. PORCENTAJE DE PROGRAMAS ACREDITADOS. PORCENTAJE DE CUMPLIMIENTO EN LOS PLANES DE MEJORAMIENTO SEGÚN RECOMENDACIONES DE EVALUACIÓN EXTERNA"
        And click on  "editar" in the first activity
        And add date  "02-03-2020"
        And click on  "Cuardar cambios"
        
        Then should show the date "02-03-2020" in the first activity
    
    Scenario: I am changing the compliance date you must put the end date
        Given entered with a director account
        When I click on button  "Cargar PDF" at the top
        And click on button  "cargar nuevo PDF"
        And click on button "seleccionar Archivo"
